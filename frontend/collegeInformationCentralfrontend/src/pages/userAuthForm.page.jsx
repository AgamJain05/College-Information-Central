...
//             return toast.error("Password must be at least 8 characters long and contain at least one uppercase, one lowercase, one number, and one special character");
//         }
...
//                     <Toaster />
//                     <form id="formElement" className="w-[80%] max-w-[400px] mx-auto" onSubmit={handleSubmit}>
//                         <h1 className="text-4xl font-gelasio capitalize text-center mb-24 text-white">
//                             {type === "sign-in" ? "Welcome Back" : "Join Us Today!"}
//                         </h1>
//                         {type === "sign-up" &&
//                             <InputBox
...
//                         <div className="relative w-full flex items-center gap-2 my-10 opacity-10 uppercase text-white font-bold">
