...
const ProfilePage = () => {
    ...
    const getBlogs = ({ page = 1, user_id }) => {
        if (!user_id) {
            user_id = blogs ? blogs.user_id : undefined;
        }
    ...
    return (
        <AnimationWrapper>
            {loading ? <Loader /> : (
                ...
                <section className="h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12 md:w-[50%] md:pl-8 md:border-1 border-grey md:sticky md:top-[100px] md:py-10">
