...
const EditProfile = () => {
    ...
    const uploadImage = async (img) => {
        ...
        const imgUrl = await fetch(`https://api.cloudinary.com/v1_1/dh05cgeok/image/upload`, {
            method: "POST",
            body: data
        });
                ...
                <form ref={editProfileForm}>
                    ...
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        ...
                        <div className="max-lg:center mb-5">
                            ...
                            <button className="btn-light mt-5 max-lg:center lg:w-full px-10" onClick={handleProfileImageUpload}>Upload</button>
                        </div>
...
// Update user profile image on the server

// const response = await axios.post(`${import.meta.env.VITE_SERVER_DOMAIN}/update-profile-img`, 
//     { url: cloudData.url }, 
//     {
//         headers: {
//             'Authorization': `Bearer ${access_token}`
...
// Assuming the response returns the updated profile image
// const newProfileImg = response.data.profile_img;